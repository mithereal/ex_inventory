defmodule Mix.Tasks.ExInventory.Install do
  @moduledoc """
    After configuring your default ecto repo in `:ecto_repos`
    Run mix ExInventory.install to generates a `ExInventory` migration,
    which creates your accounts, entries, and amounts tables, as well as
    required indexes.
  """

  def run(_args) do
    dir = Application.app_dir(:ex_inventory, "/priv/")

    files = ExInventory.Util.list_all(dir)
