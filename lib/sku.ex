defmodule ExInventory.Sku do
  ...
  alias ExInventory.Servers.Sku, as: SkuServer
  alias ExInventory.Schemas
  alias ExInventory.Repo

  @supervisor ExInventory.Sku.Supervisor
  @registry ExInventory.Sku.Registry
  ...
  @doc """
  Starts a `ExInventory.GenServers.Sku` instance for everything in the database.
